    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_category', models.ForeignKey(blank=True, to='incidents.BaleCategory', null=True, on_delete=models.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, to='incidents.BusinessLine', null=True, on_delete=models.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('is_major', models.BooleanField(default=False)),
                ('bale_subcategory', models.ForeignKey(to='incidents.BaleCategory', on_delete=models.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(blank=True, to='incidents.Comments', null=True,on_delete=models.PROTECT)),
                ('incident', models.ForeignKey(blank=True, to='incidents.Incident', null=True, on_delete=models.PROTECT)),
        ...
        migrations.AddField(
            model_name='label',
            name='group',
            field=models.ForeignKey(to='incidents.LabelGroup', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='incidenttemplate',
            name='actor',
            field=models.ForeignKey(related_name='+', blank=True, to='incidents.Label', null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='incidenttemplate',
            name='category',
            field=models.ForeignKey(blank=True, to='incidents.IncidentCategory', null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='incidenttemplate',
        ...
        migrations.AddField(
            model_name='incidenttemplate',
            name='detection',
            field=models.ForeignKey(blank=True, to='incidents.Label', null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='incidenttemplate',
        ...
        migrations.AddField(
            model_name='incident',
            name='actor',
            field=models.ForeignKey(related_name='actor_label', blank=True, to='incidents.Label', null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='incident',
            name='category',
            field=models.ForeignKey(to='incidents.IncidentCategory', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='incident',
        ...
        migrations.AddField(
            model_name='incident',
            name='detection',
            field=models.ForeignKey(related_name='detection_label', to='incidents.Label', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='incident',
        ...
        migrations.AddField(
            model_name='incident',
            name='plan',
            field=models.ForeignKey(related_name='plan_label', blank=True, to='incidents.Label', null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='file',
            name='incident',
            field=models.ForeignKey(to='incidents.Incident', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='comments',
            name='action',
            field=models.ForeignKey(related_name='action_label', to='incidents.Label', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='comments',
